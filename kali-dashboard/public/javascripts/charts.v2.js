var Graph = {
  ...
  draw : function(color,label,period,input,metric_type){  
    ...
    Graph.data[position] = prepareData(input,metric_type,mapping[period],position);
    ...
    chartContainer.append("span").attr("class","chart_current_value").text(lastValue(Graph.data[position]));
    chartContainer.append("span").attr("class","chart_value").text(lastValue(Graph.data[position]));
    return position;
  }
};